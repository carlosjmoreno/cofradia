...
function type_scripts() {
	...
	// Add Social Icons
	wp_enqueue_style( 'type-social-icons', get_template_directory_uri() . '/css/socicon.min.css', array(), '3.5.2' );

	// Theme stylesheet
	$theme_version = wp_get_theme()->get( 'Version' );
	wp_enqueue_style( 'type-style', get_stylesheet_uri(), array(), $theme_version );

	wp_enqueue_script( 'type-script', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '20201210', true );
