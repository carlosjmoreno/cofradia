                    ...
                    while ($sports_blog_banner_slider_query->have_posts()) : $sports_blog_banner_slider_query->the_post();
                        ...
                        <div class="item">
                            <?php if (has_post_thumbnail()) {
                                $thumb = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'sports-blog-full-800-600');
                                $url = $thumb['0']; ?>
            ...
            if ($sports_blog_featured_blog_query->have_posts()) :
                while ($sports_blog_featured_blog_query->have_posts()) : $sports_blog_featured_blog_query->the_post();
                    if (has_post_thumbnail()) {
                        ...
                        $large_image = $thumb['0'];
                        $thumb = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'sports-blog-720-480');
                        $small_image = $thumb['0'];
                    }else {
                        $large_image = '';
                        $small_image = '';
