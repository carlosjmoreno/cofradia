 ...
 * @since 1.0.0
 */
class Retina_Blog_Widget_Base extends WP_Widget {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'retina-blog' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'retina-blog' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'retina-blog' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo _x( 'X', 'Remove', 'retina-blog' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
