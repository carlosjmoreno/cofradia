...
if ( ! function_exists( 'retina_blog_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function retina_blog_posted_on() {
...
if ( ! function_exists( 'retina_blog_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function retina_blog_posted_by() {
...
if ( ! function_exists( 'retina_blog_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function retina_blog_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links"><i class="icon-folder icons tm-icons"></i>' . $categories_list . '</span>'); // WPCS: XSS OK.
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links"><i class="icon-tag icons tm-icons"></i>' . $tags_list . '</span>'); // WPCS: XSS OK.
			}
		}
		if(is_single()){
			edit_post_link(
...
if ( ! function_exists( 'retina_blog_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function retina_blog_post_thumbnail() {
